...
public class X2Y<T, U> extends Instruction {
  ...
  private final Function<T, U> transFunc;
  ...
  public static int i2b(int x){
    return (byte) x;
  }

  public static int i2c(int x){
    return (char) x;
  }

  public static int i2s(int x){
    return (short) x;
  }
  ...
  public void run(JThread thread) {
    ...
    var t = popFunc.apply(stack);
    var u = transFunc.apply(t);
